...
The rapid advancement and widespread deployment of large language models (LLMs) such as GPT-4, Claude 3, Llama 3 and Grok have transformed natural-language interaction with computers.
...
Real-world incidents — such as ChatGPT being tricked into providing bomb-making instructions \cite{chen2023chatgpt}, or Gemini's image-generation controversy — have demonstrated that even heavily aligned commercial models remain vulnerable.
Red teaming, originally a cybersecurity technique involving simulated attacks to expose vulnerabilities, has been adopted by leading AI organisations (OpenAI, Anthropic, Google DeepMind, Meta AI) as a core component of LLM safety evaluation \cite{openai2024redteaming}.
...
Despite significant progress, most existing open-source red-teaming frameworks suffer from limited modularity, poor support for multi-turn conversations, inadequate multilingual harm detection, or steep learning curves that hinder adoption by smaller research teams and individual developers \cite{purpur2024building, schoepf2025madmax, belaire2024automatic}.
